<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addnote.aspx.cs" Inherits="notecont" %>
...
<head runat="server">
    ...
    <style type="text/css">
     ...
     .but a:link{
         background:url(../image/note/but.png) no-repeat 0px 0px ;
         display:block;
         height:30px;
     }
     .but a:hover{
         background:url(../image/note/but2.png) no-repeat 0px 0px;
         display:block;
         height:30px;
     }
        #form1 {
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br /><asp:TextBox ID="TextBox1" runat="server" Width="380px" BorderColor="White" BorderWidth="0px" Font-Size="25px" MaxLength="15"></asp:TextBox>
        <br />
        <br />
        ...
        <asp:TextBox ID="TextBox2" 
            runat="server" Height="394px" TextMode="MultiLine" Width="380px" BorderColor="White" Font-Size="20px"></asp:TextBox>
        <br />
        <br />
