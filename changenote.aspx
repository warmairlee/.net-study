<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changenote.aspx.cs" Inherits="notecont" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br /><asp:TextBox ID="TextBox1" runat="server" Width="380px" BorderColor="White" BorderWidth="0px" Font-Size="25px"></asp:TextBox>
        <br />
        <br />
